...
Drv::LinuxI2cDriverComponentImpl i2cDrv(FW_OPTIONAL_NAME("i2cDrv")); //I2C Tutorial: LinuxI2cDriver implementation

AccelApp::AccelComponentImpl Accel(FW_OPTIONAL_NAME("Accel")); //I2C Tutorial: Accel implementation
...
bool constructApp(bool dump, U32 port_number, char* hostname) {
    ...
    // Initialize I2C tutorial components
    ...
    //I2C Tutorial: For checking if i2c-1 is opened successfully
    if (!i2cDrv.open("/dev/i2c-1"))
    {
        Fw::Logger::logMsg("[ERROR] Failed to open i2c ");
    } else {
       Fw::Logger::logMsg("[INFO] Opened i2c");
    }
