...
//Include I2C tutorial components
...
void constructAccelAppArchitecture(void);
...
extern AccelApp::AccelComponentImpl Accel; //I2C Tutorial: Accelerometer
extern Drv::LinuxI2cDriverComponentImpl i2cDrv; //I2C Tutorial: LinuxI2cDriver
