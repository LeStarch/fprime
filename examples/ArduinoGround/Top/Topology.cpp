...
#include <examples/ArduinoGpsTracker/Top/ArduinoSchedContexts.hpp>
...
Arduino::RadioWrapperComponentImpl radio("RADIO");
Arduino::SerialDriverComponentImpl gpsSerialDriver("SDRV", 2);

Gps::GpsComponentImpl gps("GPS");

Arduino::RadioForwarderComponentImpl relay("RELAY");
