...
# F Prime Base Image:
#
# The F prime base image is an Ubuntu 18.04 image some basic packages installed to ensure that
...
#  containers. It ensures the fprime virtual environment is writable by members the fprime
